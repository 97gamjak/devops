...
class LogLevel(StrEnum):
    ...
    def __le__(self, other: LogLevel) -> bool:
        ...
        -------
        bool
            True if this LogLevel is less than or equal to the other LogLevel, False otherwise.
    ...
    def __gt__(self, other: LogLevel) -> bool:
        ...
        -------
        bool
            True if this LogLevel is greater than the other LogLevel, False otherwise.
    ...
    def __ge__(self, other: LogLevel) -> bool:
        ...
        -------
        bool
            True if this LogLevel is greater than or equal to the other LogLevel, False otherwise.
    ...
    def __eq__(self, other: object) -> bool:
        ...
        -------
        bool
            True if this LogLevel is equal to the other LogLevel, False otherwise.
